...
(в моём случае docker build -t frontend:0.1.9.2 .)
(в моём случае docker build -t frontend:latest .)

(в моём случае docker build -t backend:0.1.9.2 .)
...
docker tag frontend:0.1.9.2 hakon051/tl121pet.front:0.1.9.2

docker tag backend:0.1.9.2 hakon051/tl121pet:0.1.9.2
docker tag backend:latest hakon051/tl121pet:latest

публикуем
docker push hakon051/tl121pet.front:0.1.9.2
docker push hakon051/tl121pet.front:latest

docker push hakon051/tl121pet:0.1.9.2
